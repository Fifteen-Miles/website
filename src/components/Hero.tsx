    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-7xl px-4 sm:px-6 text-center">
        ...
        >
          ...
          <span className="font-[Fraunces] italic font-light" style={{ color: "rgba(255,255,255,0.85)" }}>
            empresas e equipes
          </span>
          .
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-7 sm:mt-9 text-base sm:text-lg md:text-xl text-white/85 max-w-[90%] sm:max-w-2xl font-light tracking-tight leading-relaxed"
        >
        ...
        >
          <div className="relative w-full max-w-[1200px] mx-auto">
            ...
            <div className="mt-4 flex items-center justify-between font-[JetBrains_Mono] text-[10px] tracking-[0.25em] uppercase" style={{ color: "rgba(255,255,255,0.85)" }}>
