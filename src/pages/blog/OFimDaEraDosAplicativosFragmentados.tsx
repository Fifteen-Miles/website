    ...
    <div className="min-h-screen bg-[#FAF8F5] text-[#0F0E0C] font-[Inter] pt-32 pb-24 relative overflow-hidden selection:bg-[#0F0E0C] selection:text-[#FAF8F5]">
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-12 relative z-10">
        <motion.div initial="hidden" animate="visible" variants={fadeUp} className="mb-16">
          <Link to="/blog" className="inline-flex items-center gap-2 font-[Inter] text-xs uppercase tracking-widest text-[#706C64] hover:text-[#0F0E0C] transition-colors mb-12 border-b border-transparent hover:border-[#0F0E0C] pb-0.5">
        ...
        >
          <div>
            ...
            <Link to="/blog/soberania-de-dados-e-memoria-institucional" className="font-[Fraunces] text-2xl text-[#0F0E0C] hover:text-[#8C7355] transition-colors">
