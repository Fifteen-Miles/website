      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-12 relative z-10">
        ...
        >
          <div>
            ...
            <Link to="/blog/o-fim-da-era-dos-aplicativos-fragmentados" className="font-[Fraunces] text-2xl text-[#0F0E0C] hover:text-[#8C7355] transition-colors">
