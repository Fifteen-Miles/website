  ...
  return (
    <div className="tj-page">
      ...
      <div className="tj-coords" aria-hidden="true">
        ...
        <Link href="/contact" className="btn-premium tj-btn">Começar</Link>
      </section>
        ...
        <Reveal className="fm-product-banner">
          <div className="fm-banner-content">
            ...
            <div className="fm-banner-actions">
              ...
              <Link href="/athena" className="fm-btn-secondary">Inspecionar</Link>
            </div>
          </div>
        ...
        <Reveal className="fm-product-banner reverse">
          <div className="fm-banner-content">
            ...
            <div className="fm-banner-actions">
              ...
              <Link href="/hermes" className="fm-btn-secondary">Inspecionar</Link>
            </div>
          </div>
        ...
        <Reveal className="fm-product-banner">
          <div className="fm-banner-content">
            ...
            <div className="fm-banner-actions">
              ...
              <Link href="/hephaestus" className="fm-btn-secondary">Inspecionar</Link>
            </div>
          </div>
        ...
        <Reveal className="fm-product-banner reverse">
          <div className="fm-banner-content">
            ...
            <div className="fm-banner-actions">
              ...
              <Link href="/atlas" className="fm-btn-secondary">Inspecionar</Link>
            </div>
          </div>
        ...
        <Reveal className="fm-product-banner">
          <div className="fm-banner-content">
            ...
            <div className="fm-banner-actions">
              ...
              <Link href="/orion" className="fm-btn-secondary">Inspecionar</Link>
            </div>
          </div>
      ...
      <section className="tj-final">
        ...
        <Reveal>
          <Link href="/pricing" className="tj-btn btn-premium">Iniciar a Jornada</Link>
        </Reveal>
      </section>
